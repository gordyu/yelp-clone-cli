...
2;if(1===d)e.children=c;else if(1<d){l=Array(d);for(var m=0;m<d;m++)l[m]=arguments[m+2];e.children=l}return{$$typeof:A,type:a.type,key:f,ref:g,props:e,_owner:h}},createFactory:function(a){var b=ha.bind(null,a);b.type=a;return b},isValidElement:U,version:"16.6.1-canary-4a1072194",unstable_ConcurrentMode:Ka,unstable_Profiler:Ha,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:g};u=(Z={default:u},u)||Z;return u.default||u});
